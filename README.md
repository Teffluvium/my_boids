...
- Predator attack mode. Use `mouse`, `center`, `nearest`, or `isolated` to steer the predator with the mouse cursor or target the flock center, closest boid, or most isolated boid
    \
    `predator_attack_mode = mouse`
